...
public class Buttons
{
    ...
    public static List<string> serviceButton = new List<string> { Colour.TIME + "T" + Colour.RESET, Colour.TIME + "L" + Colour.RESET };
    public static List<string> serviceList = new List<string> { "avern", "evel Master" };
    public static List<string> otherButton = new List<string> { Colour.XP + "Y" + Colour.RESET, Colour.XP + "O" + Colour.RESET, "", "",Colour.XP + "?" + Colour.RESET };
