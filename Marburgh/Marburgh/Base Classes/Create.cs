...
public class Create
{
    ...
    private static void ChooseClass()
    {
        ...
        Console.SetCursorPosition(Return.Width(15), Return.Height(14));
        Write.EmbedColourText(Colour.CLASS, "", "[M]", "age");
        Console.SetCursorPosition(Return.Width(35), Return.Height(10));
        ...
        Console.SetCursorPosition(Return.Width(35), Return.Height(14));
